...
def get_eye_states_test_ds():
    ...
    gyro_x_open, gyro_y_open, electrodes_open, sample_numbers_open, time_ms_open, time_s_open = edf.importfile(path_random_eyes_open_ds)
    gyro_x_closed, gyro_y_closed, electrodes_closed, sample_numbers_closed, time_ms_closed, time_s_closed = edf.importfile(path_random_eyes_closed_ds)
